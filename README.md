...
<picture>
  <source
    ...
    srcset="assets/hero_dark.svg">
  <source
    media="(prefers-color-scheme: light)"
    srcset="assets/hero_light.svg">
  <img
    src="assets/hero_dark_static.svg"
    width="440"
    alt="Portrait rendered as coloured half-block characters">
</picture>

</div>

<details>
<summary>the same thing in plain text</summary>
...
| **E2** | [E3](https://github.com/DANYALAQEEL/DANYALAQEEL/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+E2+to+E3), [E4](https://github.com/DANYALAQEEL/DANYALAQEEL/issues/new?body=Please+do+not+change+the+title.+Just+click+%22Submit+new+issue%22.+You+don%27t+need+to+do+anything+else+%3AD&title=Chess%3A+Move+E2+to+E4) |
...
| Total moves |  User  |
| :---------: | :----- |
| 1 | [@muhammadabdulwasay100-dotcom](https://github.com/muhammadabdulwasay100-dotcom) |
