...
url = "https://libgen.li/index.php?req=" + urllib.parse.quote("zill solutions")
    ...
    try:
        ...
        for idx, row in enumerate(rows):
            ...
            if cell_texts:
                ...
                # Check if it relates to Complex Analysis
                if "complex" in row.lower() or "analysis" in row.lower() or "shanahan" in row.lower():
