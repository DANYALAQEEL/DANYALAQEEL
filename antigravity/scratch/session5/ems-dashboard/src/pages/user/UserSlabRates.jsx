    ...
    <div className="space-y-6">
      ...
      <div className="card p-5">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h3 className="text-sm font-semibold text-surface-200">Estimated Monthly Bill</h3>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-surface-800/60 rounded-lg p-4 text-center">
            ...
            <p className="text-xl font-bold text-surface-100">12,450</p>
          ...
          <div className="bg-surface-800/60 rounded-lg p-4 text-center">
            ...
            <p className="text-xl font-bold text-surface-100">PKR 28</p>
          ...
          <div className="bg-success-600/10 border border-success-600/30 rounded-lg p-4 text-center">
            ...
            <p className="text-xl font-bold text-success-400">PKR 3,48,600</p>
