...
export default function UserSubscription() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-6">
        <div className="flex items-start justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-surface-100">{current.plan}</h3>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-surface-800/60 rounded-lg p-4">
            ...
            <p className="text-sm font-medium text-surface-100">{current.org}</p>
          </div>
          <div className="bg-surface-800/60 rounded-lg p-4">
            <div className="flex items-center gap-2 text-surface-500 mb-1">
              <Calendar size={13} />
            ...
            <p className="text-sm font-medium text-surface-100">{current.startDate}</p>
          </div>
          <div className="bg-surface-800/60 rounded-lg p-4">
            <div className="flex items-center gap-2 text-surface-500 mb-1">
              <Calendar size={13} />
            ...
            <p className="text-sm font-medium text-surface-100">{current.endDate}</p>
          </div>
          <div className="bg-surface-800/60 rounded-lg p-4">
            <div className="flex items-center gap-2 text-surface-500 mb-1">
              <Cpu size={13} />
            ...
            <p className="text-sm font-medium text-surface-100">{current.devices}</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <h3 className="text-sm font-semibold text-surface-300 mb-3">Subscription History</h3>
        <DataTable
          columns={columns}
          data={history}
          searchable={false}
