...
const stats = [
  { label:'Monthly Energy',    value:'12,450 kWh', icon: Zap,       color:'text-primary-400'  },
  { label:'Peak Demand',       value:'24.3 kW',    icon: TrendingUp, color:'text-warning-400'  },
  { label:'Avg Power Factor',  value:'0.91',       icon: Activity,  color:'text-success-400'  },
  { label:'Cost Estimate',     value:'PKR 3,48,600',icon: Receipt,   color:'text-info-400'     },
]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 card flex flex-col" style={{ minHeight:'500px' }}>
          <div className="p-4 border-b border-surface-800 flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-medium text-surface-200">Energy AI Assistant</p>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4" style={{ minHeight:'350px', maxHeight:'420px' }}>
            ...
            {loading && (
              <div className="flex gap-2.5">
                ...
                <div className="bg-surface-800 rounded-2xl rounded-tl-sm px-4 py-3 flex items-center gap-1.5">
          ...
          <div className="card p-4">
            ...
            <div className="space-y-3">
              {stats.map(({ label, value, icon: Icon, color }) => (
                <div key={label} className="flex items-center justify-between p-3 bg-surface-800/60 rounded-lg">
          ...
          <div className="card p-4">
            ...
            <div className="space-y-2">
              {quickQuestions.map(q => (
                <button
                  key={q}
                  className="w-full text-left text-xs text-surface-300 bg-surface-800/60 hover:bg-surface-700/60 border border-surface-700 hover:border-primary-600/40 rounded-lg px-3 py-2.5 transition-colors"
