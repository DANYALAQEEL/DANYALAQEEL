...
const stats = [
  { label:'Max Imbalance',  value:'3.2%', color:'text-warning-400' },
  { label:'Avg Imbalance',  value:'1.1%', color:'text-info-400'    },
  { label:'Events Detected',value:'2',    color:'text-danger-400'  },
]
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card p-5">
        <h3 className="text-sm font-semibold text-surface-200 mb-1">Current Phase A — Main Wapda</h3>
        ...
        <ResponsiveContainer width="100%" height={260}>
          <BarChart data={historicalData}>
            ...
            />
            <Bar dataKey="currentA" fill="#16a34a" radius={[3,3,0,0]} name="Current A" />
          </BarChart>
        </ResponsiveContainer>
      </div>
