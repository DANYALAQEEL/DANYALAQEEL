...
with open(r"C:\\Users\\Administrator\\.gemini\\antigravity\\scratch\\zill_solutions\\solutions_perfected\\chapter_2\\section_2.6_solutions.md", "w", encoding="utf-8") as f:
    f.write(content)

print("Section 2.6 written successfully.")
