...
2. **Second term:**
   ...
   $$\frac{2x - 1}{\pi} \left[ \tan^{-1}(u) \right]_{-x/y}^{(2-x)/y} = \frac{2x - 1}{\pi} \left[ \tan^{-1}\left(\frac{2-x}{y}\right) - \tan^{-1}\left(-\frac{x}{y}ight) \right]$$
   $$= \frac{2x-1}{\pi} \left[ \tan^{-1}\left(\frac{x}{y}ight) - \tan^{-1}\left(\frac{x-2}{y}ight) \right]$$
Combining the results:
$$\phi(x, y) = \frac{2x-1}{\pi} \left[ \tan^{-1}\left(\frac{x}{y}ight) - \tan^{-1}\left(\frac{x-2}{y}ight) \right] + \frac{y}{\pi} \ln\left( \frac{(x-2)^2 + y^2}{x^2 + y^2} \right)$$
...
1. **First term:**
   ...
   $$= \frac{1}{\pi} \tan^{-1}\left(\frac{x+1}{y}ight) - \frac{1}{2}$$
2. **Third term:**
   ...
   $$= \frac{1}{2} + \frac{1}{\pi} \tan^{-1}\left(\frac{x-1}{y}ight)$$
3. **Second term:**
   ...
   $$= \frac{y}{2\pi} \ln\left( \frac{(x-1)^2+y^2}{(x+1)^2+y^2} \right) + \frac{x}{\pi} \left[ \tan^{-1}\left(\frac{x+1}{y}ight) - \tan^{-1}\left(\frac{x-1}{y}ight) \right]$$
Adding all three terms together:
$$\phi(x, y) = \frac{x}{\pi} \left[ \tan^{-1}\left(\frac{x+1}{y}ight) - \tan^{-1}\left(\frac{x-1}{y}ight) \right] + \frac{y}{2\pi} \ln\left( \frac{(x-1)^2+y^2}{(x+1)^2+y^2} \right) + \frac{1}{\pi} \left[ \tan^{-1}\left(\frac{x-1}{y}ight) + \tan^{-1}\left(\frac{x+1}{y}ight) \right]$$
...
3. **Third term:**
   $$\frac{x^2-y^2}{\pi} \left[ \tan^{-1}\left(\frac{t-x}{y}\right) \right]_0^1 = \frac{x^2-y^2}{\pi} \left[ \tan^{-1}\left(\frac{1-x}{y}\right) - \tan^{-1}\left(-\frac{x}{y}ight) \right]$$
   $$= \frac{x^2-y^2}{\pi} \left[ \tan^{-1}\left(\frac{x}{y}ight) - \tan^{-1}\left(\frac{x-1}{y}ight) \right]$$
Combining these results:
$$\phi(x, y) = \frac{y}{\pi} + \frac{x^2-y^2}{\pi} \left[ \tan^{-1}\left(\frac{x}{y}ight) - \tan^{-1}\left(\frac{x-1}{y}ight) \right] + \frac{xy}{\pi} \ln\left( \frac{(x-1)^2+y^2}{x^2+y^2} \right)$$
