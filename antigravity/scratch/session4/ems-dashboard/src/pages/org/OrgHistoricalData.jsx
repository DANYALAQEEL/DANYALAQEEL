    ...
    <div>
      ...
      <div className="table-container">
        <div className="p-4 border-b border-surface-800">
          <h3 className="text-sm font-semibold text-surface-300">Variable Summary</h3>
        </div>
          ...
          <table className="data-table">
            ...
            <tbody>
              {tableData.length === 0 ? (
                ...
                tableData.map(row => (
                  <tr key={row.key}>
                    <td className="font-medium text-surface-200">{row.label}</td>
                    <td className="text-danger-400">{row.min}</td>
                    <td className="text-success-400">{row.max}</td>
                    <td className="text-primary-400">{row.avg}</td>
                    <td>{row.last}</td>
                  </tr>
                ))
              )}
