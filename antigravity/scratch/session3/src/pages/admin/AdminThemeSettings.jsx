  ...
  return (
    <div>
      ...
      <div className="card p-6 max-w-2xl">
        <div className="flex items-center gap-3 mb-6 pb-5 border-b border-surface-800">
          ...
          <div>
            <h3 className="text-sm font-semibold text-surface-100">Platform Theme</h3>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-lg bg-surface-800 border border-surface-700 flex items-center justify-center text-surface-500 text-xs">
                Logo
              </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <input type="color" value={form.primaryColor}
                  ...
                  className="w-9 h-9 rounded cursor-pointer bg-surface-800 border border-surface-700 p-0.5" />
        ...
        <div className="mt-6 pt-5 border-t border-surface-800 flex justify-end">
